...
angular.module('7minWorkout')
  .controller('WorkoutController', ['$scope', '$interval', '$location','workoutHistoryTracker', function ($scope, $interval, $location,workoutHistoryTracker) {
      ...
      name:"REST BETWEEN EXERCISE",
      title:"Relax !",
      description:"Relax a bit !  Cool Down Take Deep Breaths and keep on Standing .try to move from your place and perform some walking",
      image:"img/rest.png",
       procedure: "Relaxing General Procedure invloves performing some stretching and doing some exercise that releases muscle power and it invloves performing deep breaths and walking from your position .You can have some energy drinks ",
      videos:["Mkf0SkeGwjU"]
      }),
      ...
      $scope.workoutComplete=function()
      { 
